...
public class Poisson {
    ...
    private TeamStrength calculateTeamStrength(Team team) {
        List<Match> playedMatches = team.getPastMatchesReversedAndLimit(10);
        ...
        if (!playedMatches.isEmpty()) {
            ...
            attackStrength = totalGoalsScored / playedMatches.size();
            defenseStrength = totalGoalsConceded / playedMatches.size();
        }
