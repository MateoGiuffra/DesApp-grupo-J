...
import com.desapp.football_api.services.WhoScoredService;
...
@Service
@Transactional
public class WhoScoredServiceImpl implements WhoScoredService {
    ...
    public String fetchJSONString(String targetUrl) {
        try (HttpClient client = HttpClient.newHttpClient()) {
            ...
            if (status >= 200 && status < 300) {
                ...
                throw new CustomRuntimeException("Proxy returned status " + status + " - body: " + response.body());
            }
